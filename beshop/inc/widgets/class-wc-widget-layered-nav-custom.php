 ...
 */
class WC_Widget_Layered_Nav_Custom extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_id          = 'woocommerce_layered_nav_custom';
		$this->widget_name        = __( 'Filter Products by Attribute Custom', 'woocommerce' );
		parent::__construct();
	}
...
//                error_log(print_r([$taxonomy,$terms],true));
